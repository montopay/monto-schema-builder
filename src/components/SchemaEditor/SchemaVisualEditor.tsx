...
import { createFieldSchema, updateObjectProperty, updatePropertyRequired } from "@/lib/schemaEditor";
...
const SchemaVisualEditor: React.FC<SchemaVisualEditorProps> = ({
  ...
  const hasFields = typeof schema !== 'boolean' && schema.properties && Object.keys(schema.properties).length > 0;
